...
# define SERV() std::string	(":Lisautim")
...
# define RPL_CHANNELMODEIS(nick, chan, modestr, mode_args)	(SERV() + " 324 " + nick + " " + chan + " " + modestr + " " + mode_args + END)
...
# define RPL_MODECHANGED1(nick, channel, mode)			(":" + nick + " MODE " + channel + " " + mode + END)
# define RPL_MODECHANGED2(nick, channel, mode, arg)		(":" + nick + " MODE " + channel + " " + mode + " " + arg + END)
...
//? Privmsg feedback
# define PRIVMSG(nick, user, target, msg)	(":" + UINFO(nick, user) + " PRIVMSG " + target + " " + msg + END)
# define NO_TEXTOSEND(nick)					(SERV() + " 412 " + nick + " :No text to send" + END)

//? Invite feedback
# define INVITE(nick, user, target, chan)	(":" + UINFO(nick, user) + " INVITE " + target + " " + chan + END)

//? Kick feedback
# define KICK(nick, user, chan, target, msg)	(":" + UINFO(nick, user) + " KICK " + chan + " " + target + " " + msg + END)

//? Errors feedback
# define ERR_NOSUCHNICK(nick, target)				(SERV() + " 401 " + nick + " " + target + " :No such nick/channel" + END)
# define ERR_CANNOTSENDTOCHAN(nick, channel)		(SERV() + " 404 " + nick + " " + channel + " :Cannot send to channel" + END)
# define ERR_NOSUCHCHANNEL(nick, channel)			(SERV() + " 403 " + nick + " " + channel + " :No such channel" + END)
# define ERR_NOTONCHANNEL(nick, channel)			(SERV() + " " + nick + " " + channel + " :You're not on that channel" + END)
# define ERR_CHANOPRIVSNEEDED(nick, channel)		(SERV() + " 482 " + nick + " " + channel + " :You're not channel operator" + END)
# define ERR_USERONCHANNEL(nick, target, channel)	(SERV() + " 443 " + nick + " " + target + " " + channel + " :is already on channel" + END)

//? Welcome feedback
# define RPL_WELCOME(nick)	("Lisautim :Welcome to the localhost Network, " + nick + END)
# define RPL_YOURHOST		"Lisautim :Your host is Lisautim, running version 1\r\n"
# define RPL_CREATED		"Lisautim :This server was created 8 years ago\r\n"
# define RPL_MYINFO			"Lisautim Lisautim 1 - +kiotl\r\n"
...
//? Unknown command
# define ERR_UNKNOWNCMD(nick, cmd)	(SERV() + " 421 " + nick + " " + cmd + ":Unknown command" + END)
